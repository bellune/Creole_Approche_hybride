...
data_fairseq = "datasets/kreyol-mt-hat-fra/mt_fr_fairseq"
base_dir = "model/FR_fairseq"
results_dir = "results/FR_fairseq"
...
BIN_DIR = Path(f"{base_dir}/data-bin/ht-fr")
CKPT_DIR = Path(f"{base_dir}/checkpoints/transformer_base_ht_fr")
...
def train_sentencepiece():
    ...
    spm.SentencePieceTrainer.train(
        ...
        model_prefix=str(SPM_DIR / "ht_fr_spm"),
        vocab_size=32000,
...
def apply_sentencepiece():
    ...
    sp.load(str(SPM_DIR / "ht_fr_spm.model"))
