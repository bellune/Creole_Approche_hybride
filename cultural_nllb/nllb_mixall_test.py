...
TEST_FILE = "datasets/mix_corpus/json/test_culture.jsonl"
...
print("\n===== RESULTS ON CULTURAL Mix TEST SET =====")
...
df_scores.to_csv(
    "result/cultural_MIX_test_scores_all.csv",
    index=False,
    encoding="utf-8-sig"
)
...
df_results.to_csv(
    "result/cultural_MIX_test_comparison_all.csv",
    index=False,
    encoding="utf-8-sig"
)

print("\nComparaison sauvegardée : result/cultural_MIX_test_comparison_all.csv")