...
files = {
    "basic": {
        "path": "result/Code_switching_basic_with_GPT_predictions.csv",
        "pred_col": "prediction"
    },
    "Cultural": {
        "path": "result/Code_switching_cultural_with_GPT_predictions.csv",
        "pred_col": "prediction"
    },
    "LDP": {
        "path": "result/Code_switching_ldp_with_GPT_predictions.csv",
        "pred_col": "prediction"
    }
}
...
df_scores.to_csv(
    "result/Code_switching_LLM_test_scores_all.csv",
    index=False,
    encoding="utf-8-sig"
)
...
df_results.to_csv(
    "result/Code_switching_LLM_test_comparison_all.csv",
    index=False,
    encoding="utf-8-sig"
)

print("\nScores sauvegardés : result/Code_switching_LLM_test_scores_all.csv")
print("Comparaison sauvegardée : result/Code_switching_LLM_test_comparison_all.csv")