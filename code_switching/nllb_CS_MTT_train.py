...
TRAIN_FILE = "datasets/corpus_culturel/code-switching/train/cr_cs_MT_en.jsonl"
DEV_FILE = "datasets/corpus_culturel/code-switching/dev/cr_cs_MT_en.jsonl"

OUTPUT_DIR = "model/nllb_CS_MT"
