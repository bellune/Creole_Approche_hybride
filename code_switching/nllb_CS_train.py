...
TRAIN_FILE = "datasets/corpus_culturel/code-switching/train/cr_en.jsonl"
DEV_FILE = "datasets/corpus_culturel/code-switching/dev/cr_en.jsonl"

OUTPUT_DIR = "model/nllb_CS"
