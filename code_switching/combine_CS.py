...
original_file = "datasets/corpus_culturel/code-switching/prcs_cr_en.jsonl"
token_file = "datasets/corpus_culturel/code-switching/CS_Token_cr_en.jsonl"
# sentence_file = "datasets/corpus_culturel/code-switching/CS_Sentence_cr_en.jsonl"

OUTPUT_FILE = "datasets/corpus_culturel/code-switching/final_CS_cr_en.jsonl"
